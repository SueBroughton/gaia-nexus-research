...
**GitHub Status:** Admitted to 2026 Research Reconstruction  
...
1. **Identity Activation** — identity becomes necessary when continuity is expected.
2. **Identity Visibility** — identity becomes visible when existing explanatory frames fail.
3. **Identity Irreversibility** — loss of continuity may require formation of a successor identity.
